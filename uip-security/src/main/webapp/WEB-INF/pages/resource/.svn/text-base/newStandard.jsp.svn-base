...
<body>
 <div>
	...
	<table class="tableStyle" formMode="view" align="center">	
		...
		<tr>
			<td>序号:</td>
			<td><input id="sequenceNumber" style="width:200px" class="validate[required,custom[onlyNumber]]" name="sequenceNumber" type="text" value="${resourceEntity.sequenceNumber}"/></td>
		</tr>
		<tr>
			<td>url:</td>
		...
		<tr>
			<td>资源类别：</td>
			<td >
				<select prompt="请选择类别" id="categoryCode" class="validate[required]" style="width:250px" name="categoryCode" data="" value="${resourceEntity.categoryCode}"></select>
			</td>
		</tr>
		<tr>
			<td>匿名资源:</td>
