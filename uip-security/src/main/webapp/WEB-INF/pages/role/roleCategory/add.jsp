...
<body>
 <div>
	<form id="myFormIda"  method="post" action="<%=path%>/roleCategory/save" target="frmright" failAlert="表单填写不正确，请按要求填写！">
	<table class="tableStyle" formMode="view" align="center">	
		...
		<tr style="height: 60px">
			...
			<td><input id="description" style="width:400px" class="validate[required,length[0,200]]" name="description" type="text" value="${roleCategoryEntity.description}"/></td>
		</tr>
		<tr style="height: 60px">
		    <td colspan="2">
