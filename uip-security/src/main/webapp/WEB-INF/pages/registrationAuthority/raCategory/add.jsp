	...
	<table class="tableStyle" id="tbaletable" style="width: 100%">	
		...
		<tr>
			...
			<td class="properForm2Right1">
				<input type="hidden" id="id" name="id" value="${raCategoryEntity.id}"/>
				<input id="name" class="validate[required,length[0,30]]" style="width:400px" name="name" type="text" value="${raCategoryEntity.name}"/>
			</td>
		</tr>
		<tr>
			<td class="properForm2Left">编号:</td>
			<td class="properForm2Right1"><input id="code" style="width:400px" class="validate[required,length[0,50]]"  name="code" type="text" value="${raCategoryEntity.code}"/></td>
		</tr>
		<tr>
			<td class="properForm2Left">序号:</td>
			<td class="properForm2Right1"><input id="sequenceNumber" style="width:400px" class="validate[required,custom[onlyNumber],length[0,20]]"  name="sequenceNumber" type="text" value="${raCategoryEntity.sequenceNumber}"/></td>
		</tr>
		<tr>
			<td class="properForm2Left">备注:</td>
			<td class="properForm2Right1"><input id="description" style="width:400px" class="validate[length[0,200]]" maxlength="50"  name="description" type="text" value="${raCategoryEntity.description}"/></td>
		</tr>
	</table>
	</form>
</div>
