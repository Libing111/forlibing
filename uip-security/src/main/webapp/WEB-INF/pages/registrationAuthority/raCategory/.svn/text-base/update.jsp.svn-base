 ...
 <div>
	...
	<table class="tableStyle" id="tbaletable" style="width: 100%">	
		...
		<tr>
			...
			<td class="properForm2Right1"><input id="description" class="validate[length[0,200]]" style="width:400px" maxlength="50" name="description" type="text" value="${raCategoryEntity.description}"/></td>
		</tr>
	</table>
	</form>
</div>
