...
<body>
 <div>
	<form id="myFormIda"  method="post" action="<%=path%>/resourceSet/updateSave" target="frmright" failAlert="表单填写不正确，请按要求填写！">
	<table class="tableStyle" formMode="view" align="center">	
	
		<tr style="height: 60px">
			<td style="width: 60px">名称:</td>
			<td >
				<input type="hidden" id="id" name="id" value="${resourceSetEntity.id}"/>
				<input id="name" class="validate[required]" style="width:400px" name="name" type="text" value="${resourceSetEntity.name}"/>
			</td>
		</tr>
		<tr style="height: 60px">
			<td style="width: 60px">编号:</td>
			<td><input id="code" style="width:400px" class="validate[required]"  name="code" type="text" value="${resourceSetEntity.code}"/></td>
		</tr>
		<tr style="height: 60px">
			<td style="width: 60px">备注:</td>
			<td><input id="description" style="width:400px" name="description" type="text" value="${resourceSetEntity.description}"/></td>
		</tr>
		<tr style="height: 60px">
		    <td colspan="2">
