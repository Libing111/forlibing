...
<script type="text/javascript">
	...
	function initProcessDefinitionGrid() {
		processDefinitionGrid = $("#definitions").quiGrid({
		 ...
		 url: '<%=path%>/tasks/step/management/query', 
		 sortName: 'id',
		 rownumbers:true,
		 checkbox:true,
         height: '100%', 
	...
	function initTaskDefinitionGrid() {
		taskDefinitionGrid = $("#taskDefinition").quiGrid({
		 ...
		 url:'<%=basePath%>/tasks/step/management/step/query', 
		  rownumbers:true,
		 checkbox:true,
		 enabledEdit: true,
		 usePager:false,
				...
				<fieldset> 
					...
					<table>
						<tr>
							...
							<td width="4"></td>
							<td><button type="button" onclick="resets()"><span class="icon_reload">重置查询</span></button></td>
						</tr>
					</table>
					</fieldset>
					<div class="padding_right5">
