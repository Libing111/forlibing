...
<body>
 <div >
	...
	<table class="tableStyle" formMode="view" align="center">	
		...
		<input type="hidden" id="strategyName" name="strategyName" />
		<input type="hidden" id="scenarioItemId" name="scenarioItemId" />
		<input type="hidden" id="scenarioItemName" name="scenarioItemName" />
