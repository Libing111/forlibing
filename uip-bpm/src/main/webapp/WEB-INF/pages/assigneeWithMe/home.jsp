...
//                 }},
		 ...
		 url: '<%=path%>/process/instanse/assigneeWithMe/instance/query?categoryCode='+categoryCode, 
		 sortName: 'id',
		 rownumbers:true,
		 checkbox:true,
         height: '100%', 
	...
	function onView(rowidx){
		...
		var url = '<%=basePath %>/process/instanse/assigneeWithMe/onView?processInstanceId='+ row.id +'&processDefinitionId=' + row.processDefinitionId+'&categoryCode=' + categoryCode;
