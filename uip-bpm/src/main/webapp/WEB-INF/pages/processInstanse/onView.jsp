...
<script type="text/javascript">
	...
	function initGrid() {
		grid = $("#assignee").quiGrid({
		 ...
		 url: '<%=path%>/process/instanse/monitor/instance/task/query?processInstanceId=${processInstanceId}&processDefinitionId=${processDefinitionId}',
		 sortName: 'id',
		 rownumbers:true,
		 checkbox:true,
         height: '100%', 
	...
	function goback(rowindex) {
		var url = '<%=basePath %>/process/instanse/monitor/home?categoryCode=${categoryCode}';
		window.location = url;
	}
