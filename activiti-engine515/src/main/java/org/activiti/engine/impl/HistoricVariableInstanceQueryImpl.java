...
public class HistoricVariableInstanceQueryImpl extends AbstractQuery<HistoricVariableInstanceQuery, HistoricVariableInstance> implements
  ...
  public HistoricVariableInstanceQuery variableValueLike(String variableName, Object variableValueLike) {
	    if (variableName == null) {
	      throw new ActivitiIllegalArgumentException("variableName is null");
	    }
	    if (variableValueLike == null) {
	      throw new ActivitiIllegalArgumentException("variableValue is null");
	    }
	    this.variableName = variableName;
	    queryVariableValue = new QueryVariableValue(variableName, variableValueLike, QueryOperator.LIKE, true);
	    return this;
  }
