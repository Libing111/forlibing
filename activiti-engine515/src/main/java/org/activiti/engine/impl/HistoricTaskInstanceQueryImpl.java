...
public class HistoricTaskInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricTaskInstanceQuery, HistoricTaskInstance> implements HistoricTaskInstanceQuery {
  ...
  @Override
  public HistoricTaskInstanceQuery processDefinitionIds(Set<String> processDefinitionIds) {
    this.processDefinitionIds = processDefinitionIds;
  	return this;
  }
  
  @Override
  public HistoricTaskInstanceQuery processInstanceIds(Set<String> processInstanceIds) {
