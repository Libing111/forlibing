...
public interface HistoricTaskInstanceQuery  extends Query<HistoricTaskInstanceQuery, HistoricTaskInstance> {
   ...
   * zhanghaufeng added
   */
  HistoricTaskInstanceQuery processInstanceIds(Set<String> processInstanceIds);
   ...
   * zhanghaufeng added
   */
  HistoricTaskInstanceQuery processDefinitionIds(Set<String> processDefinitionIds);
