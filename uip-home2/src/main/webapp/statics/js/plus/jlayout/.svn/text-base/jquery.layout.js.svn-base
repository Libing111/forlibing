...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	togglerLength_open:		37			// Length = WIDTH of toggler button on north/south sides - HEIGHT on east/west sides
	,	togglerLength_closed: 	37			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
